...
ap_top_terms %>%
  ...
  scale_y_reordered()
```
As shown above, the meaningful keywords can be found in each topic. From the distribution, we can see that in abnormal topic such as topic 1,5,9 and 10, the top words are dominating the topic, while in other chatter/junk/spam topics, a few normal words has relatively same high beta value.
...
were key reporters located near to N. Limnou St / N. Achilleos St reporting the hostage regarding black van. The team should notice and follow their location and provide first aid accordingly.
